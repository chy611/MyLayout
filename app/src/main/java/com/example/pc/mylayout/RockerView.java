...
import com.example.pc.mylayout.Logger;
import com.example.pc.mylayout.R;
...
public class RockerView extends View {
    ...
    private void initAttribute(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, com.example.pc.mylayout.R.styleable.RockerView);

        // 可移动区域背景
        Drawable areaBackground = typedArray.getDrawable(com.example.pc.mylayout.R.styleable.RockerView_areaBackground);
        ...
        // 摇杆背景
        Drawable rockerBackground = typedArray.getDrawable(com.example.pc.mylayout.R.styleable.RockerView_rockerBackground);
        ...
        // 摇杆半径
        mRockerRadius = typedArray.getDimensionPixelOffset(com.example.pc.mylayout.R.styleable.RockerView_rockerRadius, DEFAULT_ROCKER_RADIUS);
